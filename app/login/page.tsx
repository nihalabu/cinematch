    ...
    >
      <div className="w-full max-w-md glass rounded-2xl p-8 animate-fade-in-up shadow-[0_0_60px_rgba(229,9,20,0.05)]">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-white text-2xl font-bold mt-6 font-[family-name:var(--font-playfair)]">Welcome back</h1>
          <p className="text-[#a3a3a3] text-sm mt-2 font-[family-name:var(--font-dm-sans)] font-light tracking-wide">Sign in to your account</p>
        </div>
        ...
        <p className="text-[#a3a3a3] text-sm text-center mt-6 font-[family-name:var(--font-dm-sans)]">
          ...
          <Link href="/register" className="text-[#e50914] hover:text-[#b81c23] font-semibold transition-colors duration-300">
            Register
          </Link>
        </p>
      </div>
